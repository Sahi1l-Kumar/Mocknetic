...
//     console.log(
//       `   answers keys: ${
//         answers ? Object.keys(answers).join(", ") : "null"
//       }`
//     );
//     console.log(
//       `   answers values: ${
...
//             // Numeric comparison against expectedAnswer
//             const userNum = Number(userAnswerRaw);
//             const expectedNum = Number(question.expectedAnswer);
//             if (
...
//               console.log(
//                 `     [CIRCUIT] userNum=${userNum}, expectedNum=${expectedNum}, isCorrect=${isCorrect}`
//               );
//             } else {
//               console.log(
//                 `     [CIRCUIT] Cannot grade numerically (NaN or missing expectedAnswer)`
//               );
//             }
