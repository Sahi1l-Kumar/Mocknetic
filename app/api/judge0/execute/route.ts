...
interface ExecuteMultipleRequest extends ExecuteCodeRequest {
  testCases?: Array<{ input: string; expectedOutput: string }>;
}

export async function POST(
  request: NextRequest
): Promise<APIResponse<ExecutionResult | ExecutionResult[]>> {
  try {
    ...
    const { code, language, input, testCases }: ExecuteMultipleRequest =
      await request.json();
